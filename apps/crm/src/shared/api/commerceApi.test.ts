...
describe('commerceApi', () => {
  it('loads the operational commerce aggregate from products only', async () => {
    const fetchMock = installFetch([{ products: [] }])
  ...
  it('fails an aggregate load when products are unavailable', async () => {
